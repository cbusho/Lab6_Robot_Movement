...
void initMotor()
{
		...
		TACCTL0 |= OUTMOD_1;        // set TACCTL0 to Reset mode
		TACCTL1 |= OUTMOD_1;        // set TACCTL1 to Reset mode
		...
		TA1CCTL0 |= OUTMOD_1;        // set TACCTL0 to Reset mode
		TA1CCTL1 |= OUTMOD_1;        // set TACCTL1 to Reset mode
